...
export const Controls = ({
  ...
  return (
    <Grid gutter="xs" grow>
      ...
      <Grid.Col span={4}>
        <Button fullWidth size="xl" onClick={continu}>
          Continue
        </Button>
      </Grid.Col>
      <Grid.Col span={4}>
        <Button fullWidth size="xl" onClick={next}>
          Next Rep
        </Button>
      </Grid.Col>
      {running && (
        <Grid.Col span={12}>
          <Button fullWidth size="xl" onClick={pause}>
            Pause
          </Button>
        </Grid.Col>
      )}
      {!running && (
        <Grid.Col span={12}>
          <Button fullWidth size="xl" onClick={resume}>
            Go
          </Button>
        </Grid.Col>
      )}
